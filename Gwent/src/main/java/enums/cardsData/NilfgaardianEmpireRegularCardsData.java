...
public enum NilfgaardianEmpireRegularCardsData implements RegularCardData {
    ...
    STEFAN_SKELLEN("Stefan Skellen", Ability.SPY, false, 9, 1, RegularCardPositionType.OPPONENT_CLOSE_COMBAT),
    SHILARD_FITZ_OESTERLEN("Shilard Fitz-Oesterlen", Ability.SPY, false, 7, 1, RegularCardPositionType.OPPONENT_CLOSE_COMBAT),
    ...
    RENUALD_AEP_MATSEN("Renuald aep Matsen", Ability.SPY, false, 5, 1, RegularCardPositionType.OPPONENT_RANGED_COMBAT),
    ...
    VATTIER_DE_RIDEAUX("Vattier de Rideaux", Ability.SPY, false, 4, 1, RegularCardPositionType.OPPONENT_CLOSE_COMBAT),
    ...
    private final String smImageAddress = "/Images/Game/SmCardsImages/nilfgaard_" + this.toString().toLowerCase() + ".jpg";
    ...
    private RegularCard createCard() {
        ...
        return new RegularCard(this.name, FactionType.NILFGAARDIAN_EMPIRE, this.isHero, this.cardPositionType, this.toString(), ability);
    }
}