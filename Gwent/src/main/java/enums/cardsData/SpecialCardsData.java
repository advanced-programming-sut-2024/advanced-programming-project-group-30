...
public enum SpecialCardsData implements CardData{
    COMMANDER_HORN("Commander's Horn", "Doubles the strength of all unit cards in that row. Limited to 1 per row.", 3),
    ...
    public Image getSmImage() {
        ...
        return new Image(Objects.requireNonNull(this.getClass().getResourceAsStream("/Images/Game/SmCardsImages/monsters_" + subAddress)));
    }
