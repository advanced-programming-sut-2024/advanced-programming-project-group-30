...
public enum ScoiaTaelRegularCardsData implements RegularCardData {
    ...
    HAVEKAR_HEALER_1("Havekar Healer", "medic", false, 0, 3, RegularCardPositionType.RANGED_COMBAT),
    HAVEKAR_HEALER_2("Havekar Healer", "medic", false, 0, 3, RegularCardPositionType.RANGED_COMBAT),
    ;
