...
public enum NorthernRealmsRegularCardsData implements RegularCardData {
    ...
    KAEDWENI_SIEGE_EXPERT("Kaedweni Siege Expert", "moralBoost", false, 1, 1, RegularCardPositionType.SIEGE),
    KAEDWENI_SIEGE_EXPERT_1("Kaedweni Siege Expert", "moralBoost", false, 1, 1, RegularCardPositionType.SIEGE),
    KAEDWENI_SIEGE_EXPERT_2("Kaedweni Siege Expert", "moralBoost", false, 1, 1, RegularCardPositionType.SIEGE),
