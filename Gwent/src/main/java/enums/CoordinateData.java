...
public enum CoordinateData {
    SIEGE_ROW_PANE("siege", 0, 427),
    SCORE_LABEL("scoreLabel", 300, 20),
    ...
    TOTAL_SCORE_LABEL("totalScoreLabel", 247, 38),
    ...
    TOTAL_SCORE_IMAGE("totalScoreImage", 243, 34);
    ...
    public static CoordinateData getCoordinateData(String name) {
        for (CoordinateData coordinateData : CoordinateData.values())
            if (coordinateData.name.equals(name)) return coordinateData;
        return null;
    }
