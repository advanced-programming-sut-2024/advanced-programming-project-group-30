...
public class CardComparator implements Comparator<DeckCardData> {
    ...
    public int compare(DeckCardData a, DeckCardData b) {
        ...
        if (a instanceof WeatherCardsData) {
            if (b instanceof SpecialCardsData) return 1;
            if (b instanceof WeatherCardsData) return nameCompare;
            else return -1;
        }
        if (b instanceof SpecialCardsData || b instanceof WeatherCardsData) return 1;
